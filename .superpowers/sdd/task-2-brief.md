...
**Files:**
- Create: `wp-security-hub/src/core/engine/types.ts`

**Interfaces:**
- Produces: `SiteConfig`, `ScanConfig`, `ScanResult`, `ScanProgress`, `Finding`, `FindingSeverity`, `ConnectionType`, `RoundType`, `FixAction`, `ReportConfig`, `AgentMemory`
...
```bash
git add src/core/engine/types.ts
git commit -m "feat: add core types for sites, scans, findings, and agent memory"
```
